...
<div class="clear tabledata">
	<s:iterator value="companyList" var="companyList" status="stats" begin="0" end="0">
		<s:form id="companyForm" name="companyForm" method="POST" theme="simple" action="addCompany">
			<s:hidden name="company.companyId" id="companyId" value="%{companyId}" />
			<div class="formdata">
				<div class="formBoxFlat top-green">
					...
					<div class="top-bottom">
						...
						<s:textfield theme="simple" size="20" id="groupName" name="company.companyName" value="%{companyName}" />
					</div>
					<div class="top-bottom">
						<p>
							<label>about</label>
						</p>
						<s:textarea theme="simple" id="groupDesc" name="company.companyDesc" value="%{companyDesc}" />
					</div>
